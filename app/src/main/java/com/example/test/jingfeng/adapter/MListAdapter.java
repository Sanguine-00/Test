package com.example.test.jingfeng.adapter;
...
import com.example.test.jingfeng.bean.APIHostInfo;
import com.example.test.jingfeng.bean.Restaurant;
import com.example.test.jingfeng.util.JSONTools;
import com.example.test.jingfeng.util.ScreenUtils;
