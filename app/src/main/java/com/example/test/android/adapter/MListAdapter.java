package com.example.test.android.adapter;
...
import com.example.test.android.bean.APIHostInfo;
import com.example.test.android.bean.Restaurant;
import com.example.test.android.util.JSONTools;
import com.example.test.android.util.ScreenUtils;
